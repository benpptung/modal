      ...
      <div className="overlay" style={this.styles.overlay}>
        <div style={this.styles.inner} className="inner" onAnimationEnd={this.onAnimationEnd}>
          <div style={this.styles.wrapper}>
            <button onTouchTap={props.onClose} onClick={props.onClose} style={this.styles.button}></button>

            {(_=> merge(props.children, {closeModal: props.onClose}))()}

          </div>
        </div>
        <div style={this.styles.backdrop} onTouchTap={props.onClose} onClick={props.onClose} />
      </div>
  );
